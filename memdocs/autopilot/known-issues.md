...
- Il guanto bianco di Windows Autopilot non funziona per un sistema operativo non in lingua inglese e viene visualizzata una schermata rossa con la dicitura "operazione riuscita".
