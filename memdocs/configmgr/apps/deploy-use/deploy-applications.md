...
:::image type="content" source="media/client-toast-notification.png" alt-text="Finestra di dialogo software che notifica la necessità di una manutenzione critica del software":::
