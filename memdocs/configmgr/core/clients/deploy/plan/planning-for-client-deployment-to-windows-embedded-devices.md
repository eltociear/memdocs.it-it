...
- Filtro di scrittura basato su file (FBWF): per altre informazioni, vedere [Filtro di scrittura basato su file](/previous-versions/windows/embedded/aa940926(v=winembedded.5)).  

- RAM filtro di scrittura avanzato (EWF): per altre informazioni, vedere [Filtro di scrittura avanzato](/previous-versions/windows/embedded/ms912906(v=winembedded.5)).  

- Filtro di scrittura unificato (UWF): per altre informazioni, vedere [Filtro di scrittura unificato](/windows-hardware/customize/enterprise/unified-write-filter).  
