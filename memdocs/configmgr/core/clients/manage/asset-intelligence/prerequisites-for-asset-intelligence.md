...
|Punto di Reporting Services|Perché sia possibile visualizzare i report degli aggiornamenti software, il ruolo del sistema del sito del punto di Reporting Services deve essere installato. Per altre informazioni sulla creazione di un punto di Reporting Services, vedere [Configurazione della creazione di report](../../../servers/manage/configuring-reporting.md).|  
