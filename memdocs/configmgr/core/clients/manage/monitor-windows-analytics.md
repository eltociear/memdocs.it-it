...
Se il sito di Configuration Manager aveva una connessione a Preparazione aggiornamenti, è necessario rimuoverla e riconfigurare i client. Per altre informazioni, vedere [Rimuovere la connessione a Preparazione aggiornamenti](upgrade-readiness.md#bkmk_remove).
