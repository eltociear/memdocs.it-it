---
title: Dati di diagnostica e utilizzo per la versione 2006
titleSuffix: Configuration Manager
description: Informazioni sui dati specifici raccolti da Configuration Manager a ogni livello nella versione 2006.
ms.date: 08/11/2020
...
ms.locfileid: "88129589"
---
# <a name="diagnostic-and-usage-data-for-version-2006"></a>Dati di diagnostica e utilizzo per la versione 2006
...
Per Configuration Manager versione 2006, questo livello include i dati seguenti:
...
- Dati di base sulla gerarchia dei siti di Configuration Manager: elenco dei siti, tipo, versione, stato, numero di client, fuso orario e stato integrità
...
- Informazioni sull'integrità del sito

- Posizioni di arresto anomalo della console di Configuration Manager

- Statistiche di utilizzo della console di Configuration Manager

- Azioni di collegamento e scollegamento del cloud

- Stato dell'ultima sincronizzazione con il servizio cloud di Intune

- Conteggi degli errori dal servizio di amministrazione

- Uso del token di registrazione in blocco

- Numero di client in base al browser predefinito e preferito

- ***[Spostato]*** Statistiche di configurazione e utilizzo di Cloud Management Gateway: conteggi delle aree e degli ambienti e statistiche di autenticazione/autorizzazione  

- ***[Spostato]*** Stato integrità, utilizzo e informazioni sulla replica di SQL AlwaysOn  

- ***[Nuovo]*** Configurazione e stato di notifica della console di amministrazione

- ***[Nuovo]*** Configurazione e stato del controllo integrità del sito
...
- Numero di applicazioni di App di Microsoft 365 create tramite il dashboard  
...
- Statistiche aggregate su componenti aggiuntivi di Office, utilizzo di Office Readiness Toolkit e conteggi dei client con App di Microsoft 365
...
- Numero di dispositivi Office Pro Plus che inviano dati di integrità di Office
...
- ***[Aggiornato]*** - ***[Nuovo]*** Regole di inventario software, regole di raccolta file e stato integrità complessivo
...
- ***[Nuovo]*** Numero di riepilogo dell'evento di Analisi endpoint
...
- Utilizzo della procedura guidata di onboarding dei servizi cloud
...
- ***[Nuovo]*** Numero di impostazioni di conformità distribuite per categoria, sistema operativo e origine (cloud rispetto a sistema locale)
...
- Informazioni sulle prestazioni della console

- 25 azioni più comuni, procedure guidate, finestre delle proprietà e nodi dell'albero accessibili nella console
...
- Numero di subnet escluse dalla peer cache
...
- Statistiche aggregate per i criteri di Microsoft Defender Advanced Threat Protection
...
- Numero di aggiornamenti di App di Microsoft 365  
...
- Utilizzo del gruppo di orchestrazione

- Impostazioni di configurazione di fallback di Windows Update
...
- Stato delle richieste di reinizializzazione recenti
...
- Numero di client con utilizzo del browser
