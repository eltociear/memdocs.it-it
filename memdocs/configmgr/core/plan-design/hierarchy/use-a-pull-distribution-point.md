...
-   A partire dalla versione 1806, se gli uffici remoti hanno una connessione a Internet più efficiente oppure si vuole ridurre il carico sui collegamenti WAN, usare come origine un [punto di distribuzione cloud](use-a-cloud-based-distribution-point.md) in Microsoft Azure. Per comunicare con Microsoft Azure, il punto di distribuzione pull richiede l'accesso a Internet. Il contenuto deve essere distribuito al punto di distribuzione cloud di origine.<!--1321554-->  
