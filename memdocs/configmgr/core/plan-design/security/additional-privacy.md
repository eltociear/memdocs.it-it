...
Per altre informazioni sui dati raccolti da Log Analytics, vedere [Sicurezza dei dati di Log Analytics](/azure/log-analytics/log-analytics-data-security).
