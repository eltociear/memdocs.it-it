...
Se si aggiorna il sito prima di aggiornare l'ADK Windows, vedere [Aggiornamento dei punti di distribuzione con l'immagine d'avvio](../../../osd/get-started/manage-boot-images.md#update-distribution-points-with-the-boot-image) per miglioramenti al processo in Configuration Manager versione 1706.
