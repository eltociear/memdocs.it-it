...
Se si aggiorna il sito prima di aggiornare Windows ADK, vedere [Aggiornare i punti di distribuzione con l'immagine di avvio](../../../osd/get-started/manage-boot-images.md#update-distribution-points-with-the-boot-image) per informazioni sui miglioramenti apportati al processo in Configuration Manager versione 1710.
...
Per altre informazioni, vedere [Replication Link Analyzer](monitor-replication.md#BKMK_RLA) nell'argomento  [Monitorare la replica di database](monitor-replication.md#BKMK_RLA) .
