...
> [!NOTE]
> Il punto del data warehouse supporta credenziali alternative.<!--507334--> Specificare le credenziali usate da SQL Reporting Services per la connessione al database del data warehouse. I report del data warehouse non vengono aperti fino a quando non vengono aggiunte le credenziali.
>
...
Per risolvere questo problema, attenersi alla procedura seguente per configurare i certificati:
...
### <a name="reporting-flow"></a>Flusso di creazione dei report
