...
- [Prerequisiti del sito e del sistema del sito per System Center Configuration Manager](../plan-design/configs/site-and-site-system-prerequisites.md)
