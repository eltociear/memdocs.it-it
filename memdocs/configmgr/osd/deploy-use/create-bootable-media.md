...
A partire dalla versione 2006, il supporto di avvio può scaricare contenuto basato sul cloud. Il dispositivo necessita tuttavia di una connessione Intranet al punto di gestione. Può ottenere contenuto da Cloud Management Gateway (CMG) abilitato per il contenuto o da un punto di distribuzione cloud.<!--6209223--> Per altre informazioni, vedere [Supporto per contenuto basato sul cloud](use-bootable-media-to-deploy-windows-over-the-network.md#support-for-cloud-based-content).
