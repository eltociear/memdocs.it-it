...
È anche possibile creare profili di posta elettronica per [Android Enterprise - profilo di lavoro](email-settings-android-enterprise.md), [iOS/iPadOS](email-settings-ios.md) e [Windows 10 e versioni successive](email-settings-windows-10.md).
