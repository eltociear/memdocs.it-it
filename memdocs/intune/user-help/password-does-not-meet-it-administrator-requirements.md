...
description: Questo articolo descrive i requisiti comuni delle password che l'organizzazione potrebbe applicare.
keywords: ''
author: lenewsad
ms.author: lanewsad
manager: dougeby
...
L'organizzazione può richiedere la creazione di una password più sicura prima di consentire l'accesso alle risorse aziendali o dell'istituto di istruzione. Questo articolo descrive i requisiti comuni delle password per i dispositivi Windows 10, iOS, macOS e Android. L'organizzazione potrebbe non applicare tutti questi requisiti.  


Quando una password o un passcode non soddisfa più un requisito, si riceverà un messaggio da Portale aziendale. Verranno descritte le modifiche che è necessario apportare. Se nel messaggio non è specificato alcun dettaglio, usare questo articolo come riferimento per controllare la password corrente.  
...
Per altre informazioni o per conoscere i requisiti specifici dell'organizzazione, contattare il responsabile del supporto IT. Per informazioni sul contatto, vedere il [sito Web del Portale aziendale](https://go.microsoft.com/fwlink/?linkid=2010980).  
