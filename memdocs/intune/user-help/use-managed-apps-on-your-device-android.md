...
Quando si prova ad accedere ai dati aziendali o dell'istituto di istruzione in un'app gestita, sullo schermo compare un messaggio che indica che l'app è protetta dall'organizzazione. 
...
Le app gestite si possono ottenere in tre modi.  
...
## <a name="request-an-app-for-work-or-school"></a>Richiedere un'app per l'azienda o per l'istituto di istruzione   
 Se un’app necessaria non è disponibile nell’app Portale aziendale, è possibile richiederla. I dettagli di contatto per il **supporto tecnico** sono disponibili nella scheda **Contatta l'IT** di entrambe le app. Le stesse informazioni di contatto sono disponibili anche nel [sito Web del portale aziendale](https://go.microsoft.com/fwlink/?linkid=2010980).   
